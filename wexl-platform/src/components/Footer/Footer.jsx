      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="font-source-sans text-sm text-gray-400">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/services#packages" className="text-gray-300 hover:text-accent transition-colors">
                  Pricing Packages
                </Link>
              </li>
              <li>
                <Link to="/services#maintenance" className="text-gray-300 hover:text-accent transition-colors">
                  Maintenance Plans
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li className="flex items-start">
                ...
                <a href="mailto:narayana0249766@gmail.com" className="hover:text-accent transition-colors">
            ...
            <div className="flex space-x-4 mt-4">
              <a href="https://www.linkedin.com/in/narayana-t-a8765930a/" className="text-gray-300 hover:text-accent transition-colors" aria-label="LinkedIn">
