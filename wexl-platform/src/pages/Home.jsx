    ...
    <div className="bg-background">
      ...
      <section className="relative bg-gradient-to-br from-primary via-[#0d2f43] to-primary text-white py-20 md:py-32 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <motion.div 
              className="inline-block mb-4 px-4 py-2 bg-accent/20 rounded-full backdrop-blur-sm"
              variants={fadeInUp}
            >
              <span className="text-accent font-semibold">🚀 Transforming Ideas into Digital Excellence</span>
            </motion.div>
            ...
            <motion.p 
              className="font-source-sans text-xl md:text-2xl mb-8 text-gray-200 leading-relaxed"
              variants={fadeInUp}
            >
              Custom-built, high-performance websites that drive results. Delivered in <span className="text-accent font-bold">weeks, not months</span>. Starting from <span className="text-accent font-bold">₹25,000</span>
            </motion.p>
