  ...
  const projects = [
    {
      ...
      screenshots: [
        {
          url: getAssetPath("portfolio/federal-bank/homepge.png"),
          title: "Business Loans",
          description: "Business banking solutions and loan products"
        },
        {
          url: getAssetPath("portfolio/federal-bank/product-page.png"),
          title: "Personal Banking",
          description: "Personal banking services and features"
        },
        {
          url: getAssetPath("portfolio/federal-bank/businessloan-product.png"),
    ...
    },
    {
      ...
      screenshots: [
        {
          url: getAssetPath("portfolio/wexl-betapps/dashboard.png"),
          title: "WEXL Homepage",
          description: "Modern educational platform landing page"
        },
        {
          url: getAssetPath("portfolio/wexl-betapps/about-wexl.png"),
          title: "About WEXL",
          description: "Interactive learning management dashboard"
        },
        {
          url: getAssetPath("portfolio/wexl-betapps/bet-apps.png"),
